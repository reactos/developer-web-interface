    ...
    <Card>
     <CardHeader className='new' type='button' id={tog}>
      <div className='row'>
       ...
       <div className='col-sm'>{commit.commit.message.substring(0, 17)}...</div>
      </div>
     </CardHeader>
      ...
      <CardBody className='indent'>
       <div>
        <p>
         ...
         <a target='_blank' rel='noreferrer noopener' href={commit.html_url}>
          {commit.sha}
         </a>
        </p>
        <p>
       ...
       <div className='row'>
        ...
        <div className='col-sm'>
         ...
         <a href={`mailto:${commit.commit.author.email}`} target='_top'>
       ...
       <div className='row'>
        ...
        <div className='col-sm'>
         ...
         <a href={`mailto:${commit.commit.committer.email}`} target='_top'>
